...
// axis). Base UI's Drawer.Root owns open/close, focus, modal behavior,
// swipe gestures, snap points, nested-drawer stacking, and scroll locking —
// this only styles via `data-*`/CSS vars. Compose with Dialog for a
// responsive "Dialog on desktop, Drawer on mobile" pattern rather than
// switching automatically inside either primitive.
			...
			>
				<DrawerPrimitive.Popup
					...
					className={cn(
						...
						// Bleed — extends the popup's own background past its own edge so a
						// rubber-band overscroll never reveals the page behind it.
						...
						// Stack — geometry for the peek-and-scale effect nested drawers apply
						// to their parent (see data-nested-drawer-open above).
